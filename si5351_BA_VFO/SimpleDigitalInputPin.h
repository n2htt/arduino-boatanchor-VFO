...
public:   
   ...
   */
   static short invertState(short st);
   ...
   */
   void setLogicalState(short lst) {
   ...
   */
   SimpleDigitalPin (short pn, short md, short ini_st, bool invert)
   : pinNumber(pn)
   , mode(md)
   , state(ini_st)
   , initialState(ini_st)
...
protected:
   ...
   */
   void processPinState(long tm, short priorState);
...
public:   
   ...
   */
   void setCurrentPinMode(short pm);
   ...
   * @param  invert       is pin sense inverted?
   */
   SimpleDigitalInputPin (short pn
                  , short md
                  , short dbt
                  , short ini_st
