...
#define HEADING_PREFIX                   "N2HTT BA VFO "  // put your heading message here - but match length
...
protected: 
   ...
   short           mi_number_of_vfos;
   short           mi_currentVFO;
   short           mi_displayLine;
   boolean         mb_enabled;
